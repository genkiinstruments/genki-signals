...
export function create_trace(
	...
	var xScale = d3.scaleLinear().domain([x_domain.min, x_domain.max]).range([0, plot_width]);

	var yScale = d3.scaleLinear().domain([y_domain.min, y_domain.max]).range([0, plot_height]);
